...
// This code was taken from: https://github.com/vector-man/SplitButton
// and was released under the Apache-2.0 open source license.
...
namespace Sce.Atf.Controls
{
    ...
    public class SplitButton : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if (buttonState != PushButtonState.Pressed && IsDefault && !Application.RenderWithVisualStyles)
            {
                Rectangle backgroundBounds = bounds;
                backgroundBounds.Inflate(-1, -1);
                ButtonRenderer.DrawButton(g, backgroundBounds, buttonState);
            ...
            {
                ButtonRenderer.DrawButton(g, bounds, buttonState);
            }
            ...
            bool drawSplitLine = ((buttonState == PushButtonState.Hot || buttonState == PushButtonState.Pressed ||
            ...
            if (!string.IsNullOrEmpty(Text))
            {
                ...
                TextRenderer.DrawText(g, Text, Font, focusRect, color, formatFlags);
            }

            // Draw the focus rectangle.
            if (buttonState != PushButtonState.Pressed && Focused)
            {
